...
class TB_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control('gender_active_bg',    ['label'=>'Fondo activo',    'type'=>\Elementor\Controls_Manager::COLOR,'default'=>'#000000','selectors'=>['{{WRAPPER}} .tbw-gender-pill.active'=>'background: {{VALUE}};']]);
        ...
        $this->add_control('btn_radius_type', ['label'=>'Esquinas','type'=>\Elementor\Controls_Manager::SELECT,'options'=>['custom'=>'Personalizado','round'=>'Redondeado (pill)','square'=>'Cuadrado (0px)'],'default'=>'square']);
